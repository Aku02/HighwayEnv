...
def _register_highway_envs():
    ...
    register(
        id="racetrack-horizon-v0",
        entry_point="highway_env.envs.racetrack_env_horizon:RacetrackEnv",
    )

    register(
        id="racetrack-long-v0",
        entry_point="highway_env.envs.racetrack_env_long:RacetrackEnv",
    )
